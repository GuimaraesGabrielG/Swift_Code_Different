...
//MARK: Downcasting -> A constant or variable of a certain class type may actually refer to an instance of a subclass behind the scenes
//Use as? or as!, with their differences
for item in library {
